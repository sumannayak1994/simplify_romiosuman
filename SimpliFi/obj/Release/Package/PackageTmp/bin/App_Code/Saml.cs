    ...
    namespace Saml
    {
        ...
        public class Response
        {
            ...
            public string GetUserFirstName()
            {
                ...
                XmlNode firstName = xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name = 'FirstName']/saml:AttributeValue", manager);

                return firstName != null ? firstName.InnerText : "Guest";
            }
            ...
            public string GetUserLDAP()
            {
                ...
                XmlNode ldap = xmlDoc.SelectSingleNode("/samlp:Response/saml:Assertion/saml:AttributeStatement/saml:Attribute[@Name = 'UserID']/saml:AttributeValue", manager);

                return ldap != null ? ldap.InnerText : "Guest";
            }
        }
