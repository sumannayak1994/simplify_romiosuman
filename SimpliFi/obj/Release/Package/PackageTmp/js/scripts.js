(function () {
    ...
    //var bModal = $('#myModal');
    //var bModalBody = $('#myModal .modal-body');
    //bModalBody.niceScroll({ styler: "fb", cursorcolor: "#1b93e1", cursorwidth: '6', cursorborderradius: '0', autohidemode: 'false', background: '#FFFFFF', spacebarenabled: false, cursorborder: '0' });
