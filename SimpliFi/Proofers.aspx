...
<body>
	...
	<table width="100%">
		...
		<td width="33.33%" style="text-align:left">
			<div class="icon-bar">
			<a class="active" href="#"><i  style="font-size: 0.73em" class="fa fa-home"></i></a> </div>
		</td>
		...
		<a class="active" href="#"><i style="font-size: 0.63em" class="fa fa-bars"></i></a> </div>
		</td>
		</tr>
		</table>
	</div>
   ...
   <div class="column"  style="background-color:transparent;">
	<p style="padding-bottom:10px"> <span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#6B6E70;"> Select</span><span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#b57edc;"> DCM </span><span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#6B6E70;">File:</span></p>
     <p style="padding-bottom:10px">  <asp:FileUpload class="btn btn-4 btn-sep"  ID="FileUpload1" runat="server" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#6B6E70; top: 1px; left: 3px;" ToolTip="Select DCM file" ForeColor="white" accept=".txt"/></p>
	<p style="padding-bottom:10px">   <asp:Label ID="Label1" runat="server" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#dcdcdc;"></asp:Label></p>
  ...
  <div class="column" style="background-color:transparent;border-left:1px solid #6B6E70">
   ...
   <p style="padding-bottom:10px">  <asp:FileUpload  class="btn btn-4 btn-sep" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#6B6E70; top: 1px; left: 0px;" ID="FileUpload2" runat="server" AllowMultiple="true" ToolTip="Select .MSG file.." accept=".msg"/></p>
      <p style="padding-bottom:10px"><asp:Label ID="Label2" runat="server" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#dcdcdc;"></asp:Label>    </p>    
  ...
  <div class="column" style="background-color:transparent;border-left:1px solid #6B6E70">
   <p style="padding-bottom:10px"> <span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#6B6E70;"> Select</span><span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#b57edc;"> CGEN </span><span style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px;color:#6B6E70;">File:</span></p>
         <p style="padding-bottom:10px">     <asp:FileUpload class="btn btn-4" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#6B6E70; top: 1px; left: 0px;" ID="FileUpload3" runat="server" ToolTip="Select excel file.."/></p>
      <p style="padding-bottom:10px">  <asp:Label ID="Label3" runat="server" style="font-family:Trebuchet MS;font-size:15px;letter-spacing:2px;color:#dcdcdc;"></asp:Label></p>
...
<div id="mainButton" style="padding-top:150px;" align="center"> 
			<asp:Button class="btnMain btn-5"  style="font-family:Trebuchet MS;font-size:20px;letter-spacing:2px; top: 26px; left: 0px;" ID="Button2" runat="server" OnClick="validate" Text="VALIDATE"  />
    </div>       

<div id="gridView" style="padding-top:100px;">
			<asp:GridView ID="populateMessages" runat="server" AutoGenerateColumns="False" Font-Names="Trebuchet MS"  ForeColor="#dcdcdc" GridLines="both" BorderColor="#6B6E70" Width="90%" align="center" OnRowDataBound="OnRowDataBound" >
        
				<Columns>
            <asp:BoundField HeaderText="Activity ID" DataField="activityId"/>
            <asp:BoundField HeaderText="Element Type" DataField="elementType" />
            <asp:BoundField HeaderText="DCM Value" DataField="DCMValue" />
            <asp:BoundField HeaderText="MSG Value" DataField="MSGValue" />
